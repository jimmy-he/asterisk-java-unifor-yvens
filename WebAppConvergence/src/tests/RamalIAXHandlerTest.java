...
public class RamalIAXHandlerTest {
	...
	public final static String iax_conf = "src"+File.separator+"tests"+File.separator+"input"+File.separator+"iax.conf";
	
	public final static RamalIAX ramal = new RamalIAX("4666", "4666", "TesteApp", "senha");
	
	@Test
	public void TestReadingLocalIAXConf() throws IOException, IAXConfigException {
	...
	@Test
	public void TestListingRamalLocalIAXConf() throws IOException, IAXConfigException {
		RamalIAXHandler ramalHandler = new RamalIAXHandler(iax_conf);
