...
/**
 * Enum para representar os tipos de ramal IAX
 * 
 * @author daniel
 *
 */
public enum RamalIAXType {
	FRIEND("FRIEND");
	
	private String type;
	private RamalIAXType(String type){
		this.type = type;
	}
	 ...
	 */
	public static RamalIAXType getRamalType(String type){
