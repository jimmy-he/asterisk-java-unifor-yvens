	...
	<div class="pageTable">
		...
		<table align="center" class="result" cellspacing="0" style="width: auto;">
			...
			<c:forEach var="ramal" items="${listSip}" >
				<tr>
					<td class="result">
						<c:out value="${ramal.name}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.host}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.dyn}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.forceport}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.acl}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.port}"></c:out>
					</td>
					<td class="result">
						<c:out value="${ramal.status}"></c:out>
					</td>
				</tr>
			</c:forEach>
		</table>
		...
		<table align="center" class="result" cellspacing="0" style="width: auto;">
			<tr>
				<td class="title" colspan="7">Ramais IAX</td>
			</tr>
			<tr>
				<td class="header">Name/Username</td>
				<td class="header">Host</td>
