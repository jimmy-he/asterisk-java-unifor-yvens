...
<div class="pageBody">
	...
	<div id="columnTwo" class="pageBodyRight">
		...
		<!-- Atributos que normalmente são modificados quando criamos uma fila de espera -->

		<form method="post" action="CrudWaitQueueServlet?tarefa=${btnSubmit}&atividade=${atividade}">
